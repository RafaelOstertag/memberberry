...
class BerryRepository(@Inject private val reactiveMongoClient: ReactiveMongoClient) {
    ...
    fun findBerriesDueAfter(pointInTime: OffsetDateTime): Multi<Berry> = collection
            .find(gte("nextExecution", pointInTime))
    ...
    private fun BsonBinary.asUUID(): UUID = UuidHelper.decodeBinaryToUuid(this.data,
